...
def generate_launch_description():
    ...
    enable_slam_arg = DeclareLaunchArgument(
        "enable_slam", default_value="true", description="Enable SLAM system"
    )
    ...
    map_frame_arg = DeclareLaunchArgument(
        "map_frame", default_value="map", description="Map frame ID"
    )
    ...
    nav2_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            "use_sim_time": "false",
            "params_file": FindPackageShare("urc_navigation")
