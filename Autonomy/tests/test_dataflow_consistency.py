...
class TestDataFlowConsistency(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_sources = {"imu": Mock(), "gps": Mock(), "lidar": Mock(), "camera": Mock()}

        self.data_processors = {"fusion": Mock(), "navigation": Mock(), "control": Mock()}
    ...
    def test_timestamp_synchronization(self):
        ...
        timestamps = {"sensor1": base_time, "sensor2": base_time + 1, "sensor3": base_time + 2}
